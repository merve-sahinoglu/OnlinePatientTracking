...
namespace QuestionAnswerService.Controllers
{
    ...
    public class AnswersController : ControllerBase
    {
        ...
        public AnswersController(QuestionAnswerServiceContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Answer>> PostAnswer(Answer answer)
        {
            ...
            _eventBus.Publish(new CreateNotificationEvent("Answer", answer.AnswersText, answer.AnsweredUserId));
